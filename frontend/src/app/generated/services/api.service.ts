...
export class ApiService extends BaseService {
  ...
  statistics$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiService.StatisticsPath, 'post');
    if (params) {
  ...
  aggregate$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiService.AggregatePath, 'post');
    if (params) {
  ...
  saveData$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiService.SaveDataPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
  ...
  differenceBetweenFirstAndLast$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiService.DifferenceBetweenFirstAndLastPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
...
'input': InfluxQueryInput;
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiService.LastOccurrenceOfValuePath, 'post');
    if (params) {
...
'data': InfluxQueryInput;
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiService.ParameterAggregationWithMultipleStartsPath, 'post');
    if (params) {
      rb.body(params.body, 'application/json');
    }
...
'values': Array<SingleSimpleValue>;
    ...
    const rb = new RequestBuilder(this.rootUrl, ApiService.FilterDistinctValuePath, 'post');
    if (params) {
